...
class API_Sheet():
    def __init__(self, build_information=None, base=None, physical=None, devicegroup=None, ipv4_ethernet=None,
                 ...
                 ipv6_ospf=None, isis=None, dhcp_ipv4=None, dhcp_ipv6=None, dhcp_serverv4=None, dhcp_serverv6=None, networkgroup=None, igmp_host=None, igmp_querier=None, traffic=None, packet_editor=None, **kwargs):
    ...
    def create_excel(self,excelname='Generate_IxNetwork_Config.xlsx'):
        if self.Build_information == 'default' or self.Build_information == None:
            build_data = pd.DataFrame({'Include': ['yes']*21, 'Description':['Base Variables','Assigning Physical Ports and Topology','Assigning Device Groups to Topologies',\
                                                                             ...
                                                                             'IGMP Senders group Configuration','IGMP Receivers Group Configuration','Traffic Flow setup','Packet editor', 'DHCP_Ipv4', 'DHCP_Ipv6', 'DHCP_Serverv4', 'DHCP_Serverv6'],\
                                       'Worksheet':['Base','Physical','Devicegroup','IPv4_Ethernet','IPv6_Ethernet','IPv4_BGP','IPv6_BGP','IPv4_Loopback_BGP','BGP_Capabilities',\
                                                    'IPv4_OSPF','IPv6_OSPF','ISIS','Network_Group','IGMP_Host','IGMP_Querier','Traffic','packet_editor','DHCP_Ipv4','DHCP_Ipv6','DHCP_Serverv4','DHCP_Serverv6'], 'Status':['Completed']*21})
        ...
        if self.DHCP_Ipv6 != None:
            dhcp_data.to_excel(writer, sheet_name='DHCP_Ipv6', index=False)
        if self.DHCP_Serverv6 !=None:
