...
class API_Sheet():
    def __init__(self, build_information=None, base=None, physical=None, devicegroup=None, ipv4_ethernet=None,
                 ...
                 ipv6_ospf=None, isis=None, networkgroup=None, igmp_host=None, igmp_querier=None, traffic=None, packet_editor=None, **kwargs):
        ...
        # if self.Build_information == None or self.Build_information == 'default':
        #     buildDataDict = {}
        #     excelParameters = [base, physical, devicegroup, ipv4_ethernet, ipv6_ethernet, ipv4_bgp, ipv6_bgp, ipv4_loopback,
        #                        bgp_capabilities, ipv4_ospf, ipv6_ospf, isis, networkgroup, igmp_host, igmp_querier, traffic, packet_editor]
        #     [buildDataDict.update({excelparam.capitalize(): excelparam}) for excelparam in excelParameters if excelparam != None]
        #     self.buildData = {'Include': [], 'Description':[],  'Worksheet': [], 'Status': []}
        #     # import pdb;pdb.set_trace()
        #     for buildData, value in buildDataDict.items():
        #         self.buildData['Include'].append('yes')
        #         self.buildData['Description'].append(buildData)
        #         self.buildData['Worksheet'].append(buildData)
        #         self.buildData['Status'].append('Completed')
