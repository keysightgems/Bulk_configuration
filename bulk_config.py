                            ...
                            if topoinfo['name'] == row['Topology']:
                                ...
                                if 'IPv4_BGP' in status_dict:
                                    if status_dict['IPv4_BGP'] == True:
                                        ...
                                        bgpCapAttributes = {'IPV4 Unicast':'capabilityIpV4Unicast', 'IPv4 Multicast':'capabilityIpV4Multicast', 'IPv4 MPLS VPN':'capabilityIpV4MplsVpn',\
                                                            'VPLS':'capabilityVpls', 'Route Refresh':'capabilityRouteRefresh', 'Route Constraint':'capabilityRouteConstraint', \
                                                            'IPV6 Unicast':'capabilityIpV6Unicast', 'IPv6 Multicast':'capabilityIpV6Multicast', 'IPv6 MPLS VPN':'capabilityIpV6MplsVpn'}
                                        if 'BGP_Capabilities' in status_dict:
                                            if status_dict['BGP_Capabilities'] == True:
                                                for device_group_name in Worksheet_Dict['BGP_Capabilities']:
                                                    devicegroupinfo['name'] = devicegroupinfo['name'].replace(" ", "")
